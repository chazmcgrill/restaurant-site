  ...
  <header>
    <nav class="navbar">
      <div class="social-icons">
        <!-- <img class="social-icons--icon" src="./assets/img/svg/facebook.svg" alt="facebook icon"> -->
        <!-- <img src="./assets/img/svg/instagram.svg" alt="instagram icon"> -->
        <!-- <img class="social-icons--icon" src="./assets/img/svg/yelp.svg" alt="yelp icon"> -->
        <!-- <img class="social-icons--icon" src="./assets/img/svg/twitter.svg" alt="twitter icon"> -->
